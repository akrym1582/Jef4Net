...
if (args.Length is < 2 or > 3) throw new ArgumentException("Usage: Jef4Net.CodeGen <data directory> <output.cs> [fujitsu|hitachi|ibm|nec|unisys]");
...
string output = target.Equals("nec", StringComparison.OrdinalIgnoreCase)
    ...
    : target.Equals("fujitsu", StringComparison.OrdinalIgnoreCase)
        ...
        : throw new ArgumentException("Target must be fujitsu, hitachi, ibm, nec, or unisys.");
