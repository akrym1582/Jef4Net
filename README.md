...
Jef4Netの独自実装は[MIT License](LICENSE)です。第三者由来のマッピングデータと
保存済み文書には、それぞれ固有の条件が適用されます。出典、適用範囲、同梱する
ライセンス本文は[THIRD-PARTY-NOTICES.md](THIRD-PARTY-NOTICES.md)を参照してください。
